...
<div class="drawer lg:drawer-open">
  ...
  <div class="drawer-side">
    ...
    >
      ...
      <li>
        <a
          href="/account/stellar"
          class={adminSection === "stellar" ? "active" : ""}
          onclick={closeDrawer}
        >
          <svg
            class="h-5 w-5"
          ...
          >
            <path
              d="M4,14a1,1,0,0,1-1-.92A9.82,9.82,0,0,1,2.94,12a9,9,0,0,1,9-9,8.83,8.83,0,0,1,3,.52,1,1,0,0,1-.68,1.88A6.8,6.8,0,0,0,11.94,5,7,7,0,0,0,5.7,8.83,7.12,7.12,0,0,0,5,11.55L20.63,5.29a1,1,0,1,1,.74,1.85L4.45,13.91A1,1,0,0,1,4,14Zm16.08,2.07a8.93,8.93,0,0,0,1-4.08A9.64,9.64,0,0,0,21,10.92a1,1,0,0,0-.44-.76,1,1,0,0,0-.93-.1l-17,6.79a1,1,0,0,0-.56,1.3,1,1,0,0,0,1.3.56l15.68-6.26a7.12,7.12,0,0,1-.75,2.72A7,7,0,0,1,12.06,19a6.81,6.81,0,0,1-2.34-.4A1,1,0,1,0,9,20.48a8.84,8.84,0,0,0,3,.52A9,9,0,0,0,20.08,16.08Z"
            />
          </svg>
          Stellar
        </a>
      ...
      <li>
        <a
          href="/account/sketchup"
          class={adminSection === "sketchup" ? "active" : ""}
          onclick={closeDrawer}
        >
          <svg
            class="h-5 w-5"
